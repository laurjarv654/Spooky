        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            switch (scene)
            {
                case 99:
                    voiceLabel.Text = "";
                    mainStory.Text = "You wake up on the floor of an unfamiliar living room. No lights are on and it seems as though no one has lived here in a long time. There are three closed doors. Which one do you choose?";
                    option1.Text = "Door one.";
                    option2.Text = "Door two.";
                    option3.Text = "Door three.";
                    break;
                ...
                case 1:
                    ...
                    option1.Text = "The door.";
                    option2.Text = "The stairs.";
                    option3.Text = "Look around.";
                    break;
                ...
                case 3:
                    ...
                    option1.Text = "Try the door.";
                    option2.Text = "Go upstairs.";
                    option3.Text = "";
                    doll = true;
                    break;
                ...
                case 5:
                    ...
                    option1.Text = "Lay in the bed.";
                    option2.Text = "search the closet.";
                    option3.Text = "";
                    break;
                ...
                case 9:
                    ...
                    option1.Text = "Try the key.";
                    option2.Text = "Check out the second room.";
                    option3.Text = "";
                    break;

                case 10:
                    mainStory.Text = "You're back down in the foyer and unlock the door.";
                    option1.Text = "Coninue.";
                    option2.Text = "";
                    option3.Text = "";
                    break;
                ...
                case 11:
                    ...
                    option1.Text = "Look around.";
                    option2.Text = "Head to the foyer.";
                    option3.Text = "";
                    break;
                ...
                case 12:
                    ...
                    option1.Text = "Keep looking around.";
                    option2.Text = "Move on.";
                    option3.Text = "";
                    drawing = true;
                    break;
                ...
                case 14:
                    ...
                    option1.Text = "Struggle and try to escape.";
                    option2.Text = "Listen to the voices.";
                    option3.Text = "";
                    break;
                ...
                case 17:
                    mainStory.Text = "You search your pockets and realize that you perhaps should have spent more time searching around.";
                    option1.Text = "Continue.";
                    option2.Text = "";
                    option3.Text = "";
                    break;
                ...
                case 20:
                    mainStory.Text = "It's locked! You turn around to come face to face with a horrible creature. An inky black substance surrounds you and you become one with the darkness.";
                    option1.Text = "Continue.";
                    option2.Text = "";
                    option3.Text = "";
                    break;
